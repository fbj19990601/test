...
<body>
    <div class="login_box">
        ...
        <form name="myform" method="post" action="<?php echo U('Login/checkLogin');?>">
        	...
        	<P><b>用户名称：</b><input class="text_bg" type="text" name="username"></P>
            <P style="word-spacing:6px;"><b>登录密码：</b><input class="text_bg" type="password" name="password"></P>

            <P><b>验 证 码：</b><input type="text" class="text_bg code_bg" name="code"> 
