...
?></div>
		<div class="home_user_info">
			...
			<div class="home_message">				
				...
				<a class="f_l linkgreen" href="javascript:void(0);" style="font-size:12px; margin-left:5px;"  onclick="send_message(<?php echo $this->_var['home_user_info']['id']; ?>);">发私信</a>	
