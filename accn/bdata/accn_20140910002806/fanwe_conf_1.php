...
E_C("CREATE TABLE `fanwe_conf` (
  ...
  `value_scope` text NOT NULL COMMENT '????Χ',
...
E_D("replace into `fanwe_conf` values('21','SITE_LOGO','./public/attachment/201210/12/11/5077943312beb.jpg','1','2','','1','1','19');");
E_D("replace into `fanwe_conf` values('173','SEO_TITLE','预购一个梦想','1','0','','1','1','20');");
...
E_D("replace into `fanwe_conf` values('176','SITE_LICENSE','<a href=http://www.ac-cn.net target=_blank>ACCN站长网</a> |  <a href=http://www.ac-cn.net target=_blank>ACCN源码网</a>','1','0','','1','1','22');");
E_D("replace into `fanwe_conf` values('174','SEO_KEYWORD','SEO关键词','1','0','','1','1','21');");
E_D("replace into `fanwe_conf` values('175','SEO_DESCRIPTION','SEO描述','1','0','','1','1','22');");
