...
(5, '产品大类1', 'product bigclass', 1, 1, '产品大类1产品大类1', 'product-bigclass-1', 'product-bigclass-1', '产品大类1产品大类1', 'product-bigclass', '产品大类1产品大类1', 'product-bigclass-1', 1, 1, 'product', '', '', '', ''),
(6, '产品大类2', 'product bigclass 2', 1, 1, '产品大类2-SEO标题优化', 'product bigclass 2', 'product-bigclass-2', '产品大类2', 'product bigclass 2', '产品大类2', 'product bigclass 2', 2, 1, 'product', '', '', '', ''),
(7, '产品大类3', 'product bigclass 3', 1, 1, '产品大类3-SEO标题优化', 'product bigclass 3', 'product-bigclass-3', '产品大类3', 'product bigclass 3', '产品大类3', 'product bigclass 3', 3, 1, 'product', '', '', '', ''),
(8, '产品小类1_1', 'product smallclass 1', 5, 1, '产品小类1_1', 'product smallclass 1', 'product-smallclass-1', '产品小类1_1', 'product smallclass 1', '产品小类1_1', 'product smallclass 1', 1, 1, 'product', '', '', '', ''),
(9, '产品小类1_2', 'product smallclass 2', 5, 1, '产品小类1_2', 'product smallclass 2', 'product-smallclass-2', '产品小类1_2', 'product smallclass 2', '产品小类1_2', 'product smallclass 2', 2, 1, 'product', '', '', '', ''),
(10, '产品小类2_1', 'product smallclass 2_1', 6, 1, '产品小类2_1', 'product smallclass 2_1', 'product-smallclass2-1', '产品小类2_1', 'product smallclass 2_1', '产品小类2_1', 'product smallclass 2_1', 1, 1, 'product', '', '', '', ''),
(11, '产品小类2_2', 'product smallclass 2_2', 6, 1, '产品小类2_2', 'product smallclass 2_2', 'product-smallclass2-2', '产品小类2_2', 'product smallclass 2_2', '产品小类2_2', 'product smallclass 2_2', 2, 1, 'product', '', '', '', ''),
(12, '公司新闻', 'Company new', 2, 2, '公司新闻', 'Company new', 'Company-new', '公司新闻', 'Company new', '公司新闻公司新闻', 'Company new Company new', 1, 1, 'new', '', '', '', ''),
(13, '行业新闻', 'Industry new', 2, 2, '行业新闻', 'Industry new Industry new', 'Industry-news', '行业新闻', 'Industry new', '行业新闻行业新闻', 'Industry new Industry new Industry new', 2, 1, 'new', '', '', '', ''),
(14, '产品小类1_3', 'product smallclass 3', 5, 1, '产品小类1_3', 'product smallclass 3', 'product-smallclass-3', '产品小类1_3', 'product smallclass 3', '产品小类1_3', 'product smallclass 3', 3, 1, 'product', '', '', '', ''),
(15, '成功案例', 'Photo', 0, 15, '成功案例', 'photo title', 'photo', '成功案例', 'photo keyword', '成功案例 成功案例', 'photo photo photo', 5, 1, 'photo', '', '', '', ''),
(25, '公司简介', 'About us', 0, 25, 'PHP企业网站管理系统', 'seo-About us', 'About-us', 'PHP企业网站管理系统', 'About us', 'PHP企业网站管理系统是采用PHP+MYSQL技术和MVC模式进行开发的，架构清晰，代码易于维护。支持伪静态功能，可生成google和百度地图，支持自定义url、关键字和描述，符合SEO标准。', 'About us About us', 1, 1, 'page', '', '', '<p>\r\n PHP企业网站管理系统是采用PHP+MYSQL技术和MVC模式进行开发的，架构清晰，代码易于维护。支持伪静态功能，可生成google和百度地图，支持自定义url、关键字和描述，符合SEO标准。拥有企业网站常用的模块功能(企业简介模块、新闻模块、产品模块、下载模块、图片模块、在线留言、在线订单、友情链接、网站地图等)，强大灵活的后台管理功能，可为企业打造出专业且具有营销力的标准网站。\r\n</p>\r\n网站系统功能介绍：<br />\r\n1. 单页模块：可发布企业的各类信息，如企业简介、组织机构、企业荣誉、联系方式等，并可随意增删。 <br />\r\n2. 新闻模块：可发布企业新闻和行业新闻等，支持二级栏目，栏目个数无限制。<br />\r\n3. 产品模块：产品支持二级分类，并可对产品直接下订单询价，且支持邮件通知，更符合企业营销。 <br />\r\n4. 图片模块：以图片相册的方式，可发布成功案例或公司相册等栏目，更直观的展示企业的优越性。<br />\r\n5. 下载模块：用户可在后台上传文档资料，方便网站客户下载使用。<br />\r\n6. 在线留言：让客户的建议留言能及时反馈给企业，且支持邮件通知，让沟通变得更加方便。<br />\r\n7. 产品搜索：可对客户输入的关键字进行产品搜索，增加了网站的灵活性。<br />\r\n8. 产品复制：可对已添加的产品进行复制，从而提高了添加产品的效率。<br />\r\n9. 图片水印：可在后台设置公司的水印图片，以防止企业产品图片被盗用。<br />\r\n10. 邮件通知：在客户下订单或留言的同时，会发邮件到您指定的邮箱，让工作更有效率的。<br />\r\n11.搜索优化：全站支持伪静态，可自定义keywords、description、url，生成sitemap功能，添加内链和标签等功能。<br />\r\n<div>\r\n  <br />\r\n</div>', 'PHPCMS is using PHP+MYSQL technology and MVC pattern, structure clear, the code easier to maintain. Support the pseudo static function, can generate Google and baidu map, support custom url, keywords and description, accord with standard of SEO. With corporate websites commonly used modules (description module, news module, product module, download module, image module, online messages, online orders, links, site map, etc.), strong background management functions, flexible marketing for enterprises to create professional and has force standard web site.\r\nThe website system function is introduced:\r\nModules: 1. The single page can release enterprises of all kinds of information, such as the description, organization, enterprise honor, contact information, etc., and can freely add or delete.\r\n2. News: modules can be issued corporate news and industry news, etc., to support the secondary column, column number is unlimited.\r\n3. The product module: product support secondary classification, and can place orders directly to the product inquiry, and support email notification, conforms to the enterprise marketing.\r\n4. Image module: in the form of picture album, photo albums and other columns can be successful or company, more intuitive to show the superiority of the enterprise.\r\n5. Download module: users can upload document in the background information, convenient website customers to download to use.\r\n6. Online message: let the customer advice message timely feedback to the enterprise, and support email notification, make communication more convenient.\r\n7. Product search: input a keyword search, the products to the customer to increase the flexibility of the site.\r\nCopy: 8. Product can add the products to replicate, so as to improve the efficiency of the added products.\r\n9. Image watermark: can set up the company in the background of the watermark image, in order to prevent the enterprise product pictures stolen.\r\n10. Email notification: under customer orders or leave a message at the same time, will send email to the email address you specify, make work more efficiently.\r\n11. Search optimization: total support pseudo static, customizable keywords, description, url, generates a sitemap function, add in chain and tags, and other functions.'),
(26, '最新案例', 'Staff photo', 15, 15, '最新案例-SEO标题', 'Staff photo Staff photo', 'Staff-photo-album', '最新案例', 'Staff photo', '最新案例', 'Staff photo Staff photo Staff photo', 1, 1, 'photo', '', '', '', ''),
(27, '客户案例', 'Customer Case', 15, 15, '客户案例-SEO标题', 'Customer Case', 'Customer-Case', '客户案例', 'Customer Case', '客户案例', 'Customer Case Customer Case', 2, 1, 'photo', '', '', '', ''),
(28, '帮助文档', 'Help document', 3, 3, '帮助文档帮助文档帮助文档', 'Help document', 'download28', 'SEO关键字SEO关键字', 'Help document', 'SEO描述SEO描述SEO描述', 'Help document Help document', 1, 1, 'download', '', '', '', ''),
(29, '档案下载', 'File download', 3, 3, '档案下载档案下载档案下载档案下载', 'File download', 'download29', 'SEO关键字SEO关键字', 'File download', 'SEO描述SEO描述SEO描述', 'File download File download ', 2, 1, 'download', '', '', '', ''),
(30, '在线留言', 'Feedback', 0, 30, '', '', 'Feedback', '', '', '', '', 6, 1, 'link', '/Feedback/', '/Feedback/', '', ''),
(31, '在线订购', 'Inquiry', 0, 31, '', '', 'Inquiry', '', '', '', '', 7, 0, 'link', '/Inquiry/', '/Inquiry/', '', ''),
(39, '科技创新', 'Science and technology', 2, 2, '科技创新', 'Science and technology', 'technology', '科技创新', 'Science and technology', '科技创新', 'Science and technology', 3, 1, 'new', '', '', '', ''),
(40, '部门新闻', 'Department new', 12, 2, '部门新闻', 'Department new', 'Department-of-journalism', '部门新闻部门新闻', 'Department new', '部门新闻部门新闻部门新闻', 'Department new', 1, 1, 'new', '', '', '', ''),
(44, '产品大类4', 'product bigclass 4', 1, 1, '产品大类4-标题', 'product bigclass4 title', 'product-bigclass', '产品大类4-关键字', 'product bigclass4 keyword', '产品大类4-描述', 'product bigclass4 description description', 4, 1, 'product', '', '', '', ''),
(45, '产品小类4_1', 'product small4_1', 44, 1, '产品小类4_1-标题', 'product small4_1 title', 'list-4-75', '产品小类4_1-关键字', 'product small4_1 keyword', '产品小类4_1-描述', 'product small4_1 description', 1, 1, 'product', '', '', '', '');";
...
(1, '行车记录仪 白色真爱版WDR宽动态', '行车记录仪白色真爱版WDR宽动态1080P高清夜视广角', 'driving-record', '行车记录仪', 'PAPAGO P1pro 行车记录仪 白色真爱版 WDR宽动态 1080P高清夜视广角GoSafe600白色真爱版,WDR宽动态,夜视最清晰,拍摄角度最广', '产品介绍', 'Vehicle traveling data recorder', 'Vehicle traveling data recorder White love version of WDR wide dynamic', 'Vehicle traveling data', 'Vehicle traveling data recorder White love version of WDR wide dynamic', 'product product', 8, 1, '530860294daf2.jpg,530860295a23a.jpg,530860295aac2.jpg,530860295b15f.jpg,530860295b7ac.jpg,530860295beb7.jpg,530860295c676.jpg,530860295cd67.jpg', '5300c196f0537.png', '商品编号：1060991967', '拍摄角度：130度', '视频像素：1920*1080', '上架时间：2018-10-10 13:09:30', 'Product ID：1060991967', 'Shooting Angle: 130 degrees', 'Video pixel：1920*1080', 'Shelf time：2018-10-10 13:09:30', 0, 1)";		
...
(1, 'PHP企业网站管理系统标签调用教程', 'PHP企业网站管理系统标签调用教程seo', 'The site using the tutorial', 'seo title - The site using the tutorial', 'down', 'PHP企业网站管理系统,标签,调用', 'PHP企业网站管理系统标签调用教程', 'PHP企业网站管理系统标签调用教程', 'the tutorial', 'The site using the tutorial', '\r\n The phpcms site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;\r\n</p>\r\n<p>\r\n  The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;The site using the tutorial&nbsp;\r\n\r\n<p>\r\n <br />\r\n</p>', '530c0bb10372a.doc', 28, 3, 1, 1380356893);";
?>