...
<title><?php if ($this->_var['page_title'] != ''): ?><?php echo $this->_var['page_title']; ?> - <?php endif; ?><?php echo $this->_var['site_name']; ?> - <?php echo $this->_var['seo_title']; ?>-本程序由ACCN站长网提供；更多极品免费资源请到ACCN源码网！</title>
